...
+ (void)showSuccessWithStatus:(NSString *)string withImageType:(ImageNotice )type
{
 
    if (type == SVProgressSuccessImage)
    {
        [SVProgressHUD showImage:[UIImage imageNamed:@"SVProgressHUD.bundle/success.png"] status:string]; 
    }
    else if (type == SVProgressErroImage)
    {
        [SVProgressHUD showImage:[UIImage imageNamed:@"SVProgressHUD.bundle/error.png"] status:string]; 

    }
    else if (type == SVProgressNONetImage)
    {
        [SVProgressHUD showImage:[UIImage imageNamed:@"SVProgressHUD.bundle/noNetImage.png"] status:string]; 
 
    }
}

+ (void)showFaildWithStatus:(NSString*)status
{
    [SVProgressHUD showImage:[UIImage imageNamed:@"SVProgressHUD.bundle/error.png"] status:status];
}
