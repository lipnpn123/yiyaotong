...
- (void)getAuthorData
{
    ...
    {
        self.appKey = kSinaWeiboAppKey;
        self.appSecret = kSinaWeiboAppSecret;
        self.appRedirectURI = kSinaWeiboAppRedirectURI;
    ...
    {
        self.appKey = kTencentWeiboAppKey;
        self.appSecret = kTencentWeiboAppSecret;
        self.appRedirectURI = kTencentWeiboAppRedirectURI;
    ...
    {
        self.appKey = kDoubanBroadAppKey;
        self.appSecret = kDoubanBroadAppSecret;
        self.appRedirectURI = kDoubanBroadAppRedirectURI;
    ...
    {
        self.appKey = kRenrenBroadAppKey;
        self.appSecret = kRenrenBroadAppSecret;
        self.appRedirectURI = kRenrenBroadAppRedirectURI;
        KRShareAuthInfo = [[NSUserDefaults standardUserDefaults] objectForKey:@"KRShareAuthData-Renren"];
    }
    else if(shareTarget == KRShareTargetWangyiblog)
    {
        self.appKey = kWangyiWeiboAppKey;
        self.appSecret = kWangyiWeiboAppSecret;
        self.appRedirectURI = kWangyiWeiboAppRedirectURI;
        KRShareAuthInfo = [[NSUserDefaults standardUserDefaults] objectForKey:@"KRShareAuthData-Wangyi"];
    }
    ...
    {
        self.accessToken = [KRShareAuthInfo objectForKey:@"AccessTokenKey"];
        self.expirationDate = [KRShareAuthInfo objectForKey:@"ExpirationDateKey"];
        self.userID = [KRShareAuthInfo objectForKey:@"UserIDKey"];
    }
    else{
...
- (void)storeAuthData
{
    ...
    {
        [[NSUserDefaults standardUserDefaults] setObject:authData forKey:@"KRShareAuthData-Wangyi"];
    }
...
- (void)requestAccessTokenWithAuthorizationCode:(NSString *)code
{
    ...
    {
        AccessTokenURL = kWangyiWeiboWebAccessTokenURL;
    }
...
- (void)notifyTokenExpired:(id<KRShareRequestDelegate>)requestDelegate
{
    ...
    {
        SDKErrorDomain = kWangyiWeiboSDKErrorDomain;
    }
...
- (void)logOut
{
    ...
    {
        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"KRShareAuthData-Wangyi"];
    }
    [[NSUserDefaults standardUserDefaults] synchronize];
                            ...
                            delegate:(id<KRShareRequestDelegate>)_delegate
{
    ...
    if ([self isAuthValid])
    {
        ...
        {
            SDKDomain = kWangyiWeiboSDKAPIDomain;
        }
