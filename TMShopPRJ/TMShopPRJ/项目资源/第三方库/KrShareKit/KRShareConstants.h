...
#define WangyiWeiboSdkVersion                @"2.0"
#define kWangyiWeiboSDKErrorDomain           @"TCWangyiSDKErrorDomain"
#define kWangyiWeiboSDKErrorCodeKey          @"TCWangyiSDKErrorCodeKey"
#define kWangyiWeiboSDKAPIDomain             @"https://api.t.163.com/"
#define kWangyiWeiboSDKOAuth2APIDomain       @"http://api.t.163.com/oauth/access_token"
#define kWangyiWeiboWebAuthURL               @"https://api.t.163.com/oauth2/authorize"
#define kWangyiWeiboWebAccessTokenURL        @"https://api.t.163.com/oauth2/access_token"
#define kWangyiWeiboAppAuthURL_iPhone        @"sinaweibosso://login"
#define kWangyiWeiboAppAuthURL_iPad          @"sinaweibohdsso://login"
